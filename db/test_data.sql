...
insert  into `personas`(`nombre`,`apellido`,`dni`,`usuario`,`password`,`telefono`) values ('luna','sol',11111111,'lunasol','nube',989876525),('nazareno','defede',12345678,'nazo','denazo',3402499684),('Pepe','Luis',33846883,'pepelui','hola',9887760);


/*Data for the table `reservas` */

insert  into `reservas`(`nroreserva`,`usuario`,`isbn`,`fecha_desde`,`fecha_hasta`) values (8,'pepelui',123456787,'2013-05-28','2013-06-12'),(9,'pepelui',2147483647,'2013-05-29','2013-06-13'),(11,'pepelui',123456789,'2013-05-29','2013-06-13'),(28,'pepelui',1234567845,'2013-06-05','2013-06-20'),(29,'pepelui',123456784,'2013-06-05','2013-06-20'),(30,'pepelui',950072298,'2013-06-09','2013-06-24'),(31,'lunasol',97898711185,'2013-06-12','2013-06-27');
